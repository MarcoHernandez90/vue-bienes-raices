...
/* Primero obtenermos la referencia de las credenciales de la aplicación */
const db = useFirestore()
/* Luego la referencia del documento con los parametros de la aplicación,
  la colección y el documento */
const docRef = doc(db, 'propiedades', route.params.id)
/* Usamos useDocument para traer el documento utilizando la referencia */
...
const submit = handleSubmit(async (values) => {
  ...
  if (image.value) {
    ...
    console.log('🚀 ~ file: EditarPropiedadView.vue:61 ~ submit ~ data:', data)
